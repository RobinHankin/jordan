...
to a $x\times 5$ symmetric matrix (because the default `n=5`).  Thus
each element has $5*(5+1)/2=15$ degrees of freedom, as indicated by
the row labelling.  Addition and multiplication of a Jordan object
with a scalar are defined:
